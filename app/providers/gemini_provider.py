...
from app.schemas.quote_schema import GeneratedQuotesResponse, QuoteSchema
...
class GeminiProvider(AIProvider):
    ...
    """
        ...
        try:
            response = self.client.models.generate_content(
                ...
                config={
                    ...
                    "response_schema": GeneratedQuotesResponse,
                },
            )
        ...
        if not parsed_response or not parsed_response.quotes:
            logger.error(
